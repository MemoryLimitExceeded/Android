  ...
  - ###### 遍历流程
    ...
    private void performTraversals() {
        ...
        if (layoutRequested) {
            ...
            windowSizeMayChange |= measureHierarchy(host, lp, res, desiredWindowWidth, desiredWindowHeight);				//预测量
        }
        ...
        ...
        if (mFirst || windowShouldResize || insetsChanged || viewVisibilityChanged || params != null || mForceNextWindowRelayout) {
    		...
    		if (!mStopped || mReportNextDraw) {
                ...
                if (focusChangedDueToTouchMode || mWidth != host.getMeasuredWidth()
                    ...
                    ...
                    // Ask host how big it wants to be
                    performMeasure(childWidthMeasureSpec, childHeightMeasureSpec);				//最终测量阶段
    				...
    				if (measureAgain) {
    ...
    - 绘制
      ...
      不过在 ViewGroup 中它就拥有子 View，因此 ViewGroup 重写了 dispatchDraw()，但是 ViewGroup 本身仍没有内容所以它没有重写 onDraw()。
      ...
      上面有四个地方调用了 drawChild()，这里就不细讲它们是怎么调用的。drawChild() 调用了 View.draw() 的三参数方法：
...
- ###### View 的事件分发
  ...
  -   Activity.dispatchTCallbackouchEvent()
